...
const Navbar = ({mode, setMode, lightColor, darkColor}) => {
    ...
    return (
        <header 
            style={{background: mode ? lightColor : darkColor, borderBottom: mode? `1px solid ${darkColor}` : `1px solid ${lightColor}`}}
            onScroll={(event) => onScrollEffect(event, 80, "onScrollNav")} id="home-header">
